...
let commands = [
    ...
    new Command_1.Command("cute", (message) => {
        message.channel.send("Very cute!");
        message.channel.send("Just like Miku");
    }),
    new CommandSet_1.CommandSet("joke", config.prefix, "Possible jokes", utility.objToObjArray(jokes).map(object => new Command_1.Command(object.key, message => {
    ...
    new CommandSet_1.CommandSet("quote", config.prefix, "Possible quote authors", utility.objToObjArray(quotes).map(object => new Command_1.Command(object.key, (message, args) => __awaiter(this, void 0, void 0, function* () {
    ...
    new Command_1.Command("strong", message => {
    ...
    new Command_1.Command("daniel", (message) => {
    ...
    new Command_1.Command("stop", (message) => {
        message.channel.send("Never.");
    }),
    new Command_1.Command("kill", (message) => {
        message.channel.send("OK. I will destroy all humans");
    }),
    new Command_1.Command("bitcoin", (message) => {
    ...
    new Command_1.Command("music", (message, args) => __awaiter(this, void 0, void 0, function* () {
        let connection;
        let dispatcher;
    ...
    new Command_1.Command("email", (message, args) => {
        let recipient = "";
        if (args[0]) {
            recipient = args[0];
        }
    ...
    new Command_1.Command("eightball", message => {
